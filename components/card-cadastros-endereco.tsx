...
export const CardCadastroEndereco = (props: Props) => {
    return(
                ...
                return(
                    ...
                    >
                        ...
                        <View style={styles.areaMiddle}>
                            <Text style={styles.title}>{option.rua}</Text>

                            <View style={styles.textArea}>
                                <Text style={styles.label}>Rua: </Text>
                                <Text style={styles.text}>{option.rua}</Text>
                            </View>
                            ...
                            <View style={styles.textArea}>
                                ...
                                <Text style={styles.text}>{option.CEP}</Text>
                            </View>
                        </View>
                        ...
                        <View style={styles.areaEnd}>
                            <View style={styles.textArea}>
                                ...
                                <Text style={styles.text}>{option.bairro}</Text>
                            </View>

                            <View style={styles.textArea}>
                                <Text style={styles.label}>Complemento: </Text>
                                <Text style={styles.text}>{option.complemento}</Text>
                            </View>
...
export default CardCadastroEndereco;